...
/* $Id: Smarty.class.php,v 1.2 2007/03/04 15:38:22 pieter Exp $ */
...
class Smarty
{
     ...
     * @var array
     */
    var $plugins_dir     =  array('plugins', SMARTY_PLUGIN_DIR);
 ...
 */
    ...
    {
        if(DEBUG_SMARTY_TEMPLATES) {
        	echo "<pre>".$resource_name."</pre>";
        }
