...
$(document).ready(function() {
	$("#ddisconame").autocomplete("/servlets/autocomplete/disco.php", {
		...
		selectFirst: false,
		extraParams: {
			cityid: 	function() { return $("#sdcityid").val();},
			countryid:	function() { return $("#cicountryid").val();}
		}
	});
			...
			<table border="0" cellpadding="0" cellspacing="0">
	        	<tr>
	        		<td valign="top" height="0">
	        			<label class="search_advancedlabel" for="ddisconame">Disco/kroeg:</label><br/>
						<input class="search_advancedinput" type="text" tabindex="1" value="{$ddisconame}" name="ddisconame" id="ddisconame"/>
	        		</td>
	        		<td valign="top">
	                	<label class="search_advancedlabel">Plaats:</label><br/>
						<input class="search_advancedinput" type="text" tabindex="2" value="{$cicityname}" name="cicityname" id="cicityname" />
						<input type="hidden" name="sddiscoid" id="sddiscoid" value="{$sddiscoid}"/>
						<input type="hidden" name="sdcityid" id="sdcityid" value="{$sdcityid}"/>
	        		</td>
	        		<td valign="top">
				...
				<tr>
	        		...
	        		<td valign="top">
	        			...
	        			{html_options style="margin-top:8px;" name="dsex" options=$sex_options selected=$dsex id="dsex"}
	        		</td>
				</tr>
			</table>
		</form>
